...
<?php if ($is_front) : /* if we are on the front page use <h1> for site title */ ?>
 <h1 class="sitetitle">
	      <a href="<?php print $base_path.($language === null ? "" : $language->prefix) ?>" title="<?php print t('Home') ?>">
	        <?php print $site_name ?>
	      </a>
	    </h1>	    
 <?php endif; ?>
...
<?php } ?>
  ...
  <div class="wrapper"><!--wrapper:defines whole content margins-->
    ...
    <div style="padding:5px 0 5px 85px; border-bottom: 1px dashed #cccccc;">
        <script type="text/javascript"><!--
        google_ad_client = "pub-2262240967811999";
        /* 728x90, page-top */
        google_ad_slot = "6367508816";
        google_ad_width = 728;
        google_ad_height = 90;
        //-->
        </script>
