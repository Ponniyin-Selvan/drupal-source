...
//require_once(dirname(__FILE__).'/plugins/eZ/Base/src/base.php');
...
function __autoload( $className ) {
	echo "auoload $className\n ";
        ezcBase::autoload( $className );
	echo "after auoload $className\n ";
}*/
class PluginManager {
    ...
    public function register($pluginName, $pluginFolder, iPlugin &$plugin, $pluginFolderSettings) {
		...
		$pluginSettings = (array_key_exists($pluginSettingName, $this->settings) ? 
							$this->settings[$pluginSettingName] : array());
		$folderSettings = (array_key_exists($pluginSettingName, $pluginFolderSettings) ? 
							$pluginFolderSettings[$pluginSettingName] : $pluginFolderSettings);
		$pluginSettings = array_merge($this->settings, $pluginSettings);
